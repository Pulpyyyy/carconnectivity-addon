...
Per `Škoda` con l'origine dati **produttore** sull'add-on **Edge** (API pubblica ufficiale Škoda, connettore v0.13+; l'add-on stabile mantiene l'accesso con nome utente/password qui sopra):

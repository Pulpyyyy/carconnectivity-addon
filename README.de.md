...
Für `Škoda` mit der Datenquelle **Hersteller** im **Edge-Add-on** (offizielle öffentliche Škoda-API, Konnektor v0.13+; das stabile Add-on nutzt weiterhin die Anmeldung mit Benutzername/Passwort oben):

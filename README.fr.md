...
Pour `Škoda` avec la source de données **constructeur** sur l'add-on **Edge** (API publique officielle Škoda, connecteur v0.13+ ; l'add-on stable conserve la connexion identifiant/mot de passe ci-dessus) :

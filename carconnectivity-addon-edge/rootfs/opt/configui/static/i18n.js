...
var I18N = {
  en: {
    ...
    mqtt_log: "MQTT log level",
    mqtt_log_hint: "(MQTT plugin only)",
  ...
  fr: {
    ...
    mqtt_log: "Niveau de journal MQTT",
    mqtt_log_hint: "(plugin MQTT uniquement)",
  ...
  de: {
    ...
    mqtt_log: "MQTT-Protokollstufe",
    mqtt_log_hint: "(nur MQTT-Plugin)",
  ...
  it: {
    ...
    mqtt_log: "Livello di log MQTT",
    mqtt_log_hint: "(solo plugin MQTT)",
  ...
  es: {
    ...
    mqtt_log: "Nivel de registro MQTT",
    mqtt_log_hint: "(solo plugin MQTT)",
  ...
  pl: {
    ...
    mqtt_log: "Poziom dziennika MQTT",
    mqtt_log_hint: "(tylko wtyczka MQTT)",
  ...
  pt: {
    ...
    mqtt_log: "Nível de registo MQTT",
    mqtt_log_hint: "(apenas plugin MQTT)",
  ...
  no: {
    ...
    mqtt_log: "MQTT-loggnivå",
    mqtt_log_hint: "(kun MQTT-utvidelse)",

...
var I18N = {
  en: {
    ...
    autologin_hint: "(use “autologin” for no login)",
  ...
  fr: {
    ...
    autologin_hint: "(utilisez « autologin » pour aucune connexion)",
  ...
  de: {
    ...
    autologin_hint: "(„autologin“ verwenden für keine Anmeldung)",
  ...
  it: {
    ...
    autologin_hint: "(usa “autologin” per nessun accesso)",
  ...
  es: {
    ...
    autologin_hint: "(usa “autologin” para no iniciar sesión)",
  ...
  pl: {
    ...
    autologin_hint: "(użyj „autologin”, aby pominąć logowanie)",
  ...
  pt: {
    ...
    autologin_hint: "(use “autologin” para sem início de sessão)",
  ...
  no: {
    ...
    autologin_hint: "(bruk «autologin» for ingen pålogging)",

...
- **hassio-addons/base** → [21.0.5](https://github.com/hassio-addons/addon-base/releases/tag/v21.0.5)
...
- **CarConnectivity-connector-vw-eu-data-act** → v0.3.1
...
- **hassio-addons/base** → [21.0.4](https://github.com/hassio-addons/addon-base/releases/tag/v21.0.4)
...
- **CarConnectivity-connector-skoda** → v0.13a3
...
- **CarConnectivity-connector-skoda** → v0.13a1
- **CarConnectivity-connector-volkswagen-na** → v0.2.0
...
- **hassio-addons/base** → [21.0.3](https://github.com/hassio-addons/addon-base/releases/tag/v21.0.3)

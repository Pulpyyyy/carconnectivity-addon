...
Dla `Škoda` ze źródłem danych **producent** w dodatku **Edge** (oficjalne publiczne API Škody, konektor v0.13+; stabilny dodatek nadal używa logowania nazwą użytkownika/hasłem powyżej):

...
var I18N = {
  en: {
    ...
    save_unreachable: "The add-on did not answer (HTTP {code}). It is probably stopped or restarting: check the add-on log, then reload this page.",
    error: "Error: {msg}",
  ...
  fr: {
    ...
    save_unreachable: "L’add-on n’a pas répondu (HTTP {code}). Il est probablement arrêté ou en cours de redémarrage : consultez son journal, puis rechargez cette page.",
    error: "Erreur : {msg}",
  ...
  de: {
    ...
    save_unreachable: "Das Add-on hat nicht geantwortet (HTTP {code}). Es ist wahrscheinlich gestoppt oder startet neu: prüfen Sie sein Protokoll und laden Sie diese Seite neu.",
    error: "Fehler: {msg}",
  ...
  it: {
    ...
    save_unreachable: "L’add-on non ha risposto (HTTP {code}). Probabilmente è fermo o si sta riavviando: controlla il suo log, poi ricarica questa pagina.",
    error: "Errore: {msg}",
  ...
  es: {
    ...
    save_unreachable: "El complemento no respondió (HTTP {code}). Probablemente está detenido o reiniciándose: revisa su registro y recarga esta página.",
    error: "Error: {msg}",
  ...
  pl: {
    ...
    save_unreachable: "Dodatek nie odpowiedział (HTTP {code}). Prawdopodobnie jest zatrzymany lub uruchamia się ponownie: sprawdź jego dziennik, a następnie odśwież tę stronę.",
    error: "Błąd: {msg}",
  ...
  pt: {
    ...
    save_unreachable: "O add-on não respondeu (HTTP {code}). Provavelmente está parado ou a reiniciar: consulte o seu registo e recarregue esta página.",
    error: "Erro: {msg}",
  ...
  no: {
    ...
    save_unreachable: "Tillegget svarte ikke (HTTP {code}). Det er sannsynligvis stoppet eller starter på nytt: sjekk loggen, og last inn siden på nytt.",
    error: "Feil: {msg}",

...
> [!IMPORTANT]
> ### 🚧 Bloqueo de la API de VAG — Volkswagen / Audi / Seat / Cupra / Skoda (mayo de 2026)
>
> Desde finales de mayo de 2026, el Grupo Volkswagen ha restringido el acceso de terceros a sus API. Los conectores habituales de VW/Audi/Seat/Cupra devuelven errores `403` y ya no recuperan datos, aunque las aplicaciones oficiales sigan funcionando. Actualmente no existe ninguna solución para estos conectores.
>
> **Solución alternativa:** el conector de solo lectura `Volkswagen EU Data Act` está **✅ disponible en la versión `edge`** del complemento.
>
